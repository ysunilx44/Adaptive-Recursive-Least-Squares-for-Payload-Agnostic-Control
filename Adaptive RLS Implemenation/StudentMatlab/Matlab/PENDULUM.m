...
%             
            ...
            %MAKE AXIS LOOK NICE
            axis equal
            axis([-obj.m_WS/2-0.1 obj.m_WS/2+0.1 -0.6 0.6 -1.2 1.1])
        ...
        function UPDATE_OTHER_DATA(obj)
            ...
            if del_t ~= 0
                ...
                [~, Q] = ode45(@(T,Q)dequations(T,Q,u,L,Mp,Mc,b,Mode),T,Q);                     
                Q = Q(end,:);
